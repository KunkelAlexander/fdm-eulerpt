...
if constants.NONLINEAR_GROWTH_MODE is constants.NonlinearGrowthModes.ANALYTICAL_FDM:
    from fdm.util import b_f
    from fdm.couplings.analytical import f1, f2, G, ds_G, dseta_G, deta_G
elif constants.NONLINEAR_GROWTH_MODE is constants.NonlinearGrowthModes.SUPPRESSED_CDM:
    from fdm.util import b_f
    from fdm.couplings.suppressed_cdm import f1, f2, G, ds_G, dseta_G, deta_G
elif constants.NONLINEAR_GROWTH_MODE is constants.NonlinearGrowthModes.ANALYTICAL_CDM:
    from cdm.util import b_f
    from cdm.couplings.analytical import f1, f2, G, ds_G, dseta_G, deta_G
elif constants.NONLINEAR_GROWTH_MODE is constants.NonlinearGrowthModes.NUMERICAL_FDM:
    from fdm.util import b_f
    from fdm.couplings.numerical import f1, f2, G, ds_G, dseta_G, deta_G
elif constants.NONLINEAR_GROWTH_MODE is constants.NonlinearGrowthModes.NUMERICAL_FIT:
    from fdm.util import b_f
    from fdm.couplings.fit import f1, f2, G, ds_G, dseta_G, deta_G
else:
